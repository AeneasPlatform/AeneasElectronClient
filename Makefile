...
clean:
	rm -f dictionary.pot $(SRC_DIR)/translations.json

makemessages: dictionary.pot
...
dictionary.pot: $(GETTEXT_HTML_SOURCES)
...
$(SRC_DIR)/translations.json: clean dictionary.pot
	mkdir -p $(OUTPUT_DIR)
