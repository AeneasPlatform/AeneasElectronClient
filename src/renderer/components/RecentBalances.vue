		...
		<div class="col-md-12 col-lg-12">
			<div class="card">
				...
				<div class="card-block blocks">
					<b-button type="button" variant="default" @click="loadBalances"
										class="btn btn-outline-dark ae-border">
				...
				<div class="card-block blocks horscroll">
					<table class="table blocksfont">
						<thead>
						<tr>
							<th @click="sort('addr')" scope="col">
								<translate>Address</translate>
							</th>
							<th scope="col">
								<translate>Balance</translate>
							</th>
							<th @click="sort('blocksCount')" scope="col">
								<translate>Blocks count</translate>
							</th>
							<th scope="col">
								<translate>In. Tx. count</translate>
							</th>
							<th scope="col">
								<translate>Out. Tx. count</translate>
							</th>
						</tr>
						</thead>
