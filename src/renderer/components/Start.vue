			...
			<div class="container fill">
				...
				<div class="row motto-title">
					<div class="col text-center">
						...
						<b-dropdown name="language" id="lang" v-model="$language.current" class="m-md-2 ae-dropdown"
									:text="$language.available[$language.current]">
							<b-dropdown-item v-on:click="$language.current=key" v-bind:key="(language, key)"
											 v-for="(language, key) in $language.available" :value="key">{{ language }}
							</b-dropdown-item>
						</b-dropdown>
					</div>
